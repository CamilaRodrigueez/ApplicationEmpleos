...
public class Usuario {
	...
	@ManyToMany(fetch=FetchType.EAGER)//Sive para especificar que cuando consultemos un usuario recupere todos los perfiles que tiene relacionado dicho usuario.
